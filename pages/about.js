                ...
                <div>
                    <div className="flex flex-row mb-3 p-3">
                        ...
                        <div className="w-8/12 p-3 mb-3">
                            ...
                            <b>Nicholas Berglund</b> has been based in Paris for 12 years, now lives between Milan and Spain. Nicholas started in this industry more than 30 years ago when he became a manager of a still and film production studio in Copenhagen, which he also helped build. He worked his way up as a runner, production manager, gaffer, grip and producer while getting a degree in marketing at night. By the mid-‘90s Nicholas was working in production on feature films, and in 1994 became head of TV at Young & Rubicam Denmark . After starting and selling his own production company, Nicholas came to Paris and worked for The Gang Films to develop its international network and seeking talents. He then started the company Nicholas Berglund in 2009.  Now with 30 years of experience in the creative, advertising, fashion, and production industries, Nicholas Berglund has worked with renowned advertising agencies such as Publicis, Ruini e Mariotti, EURO RSCG, Ogilvy & Mather, Saatchi, BBDO, Forsman Bodenfors, Wieden + Kennedy, and Dentsu. Nicholas Berglund has serviced a wide range of international clients, including Apple, Audi, Bang & Olufsen, BMW, FIAT Group, Roger Dubuis, GUCCI, Levi`s, SKODA, Mercedes to name a few. Nicholas Berglund is known as the guy who knows everyone everywhere.
                            </section>
                            <section className="text-xs text-third leading-5 text-justify mb-5">
                            <b>Rick Romaniuk</b> is based in Prague, and has started in the industry 12 years ago, moving from work on set in various departments to bidding, producing and eventually managing directors. Drawing from the experience from years spent working at Radioaktive film in Kyiv, a connection has been made that lead to a successful collaboration with NB resulting in an effective partnership with Nicholas Berglund. Efficient workflow lead by Rick allowed NB: to maximise the reach of clients and talents, while manifesting the core values of Nicholas Berglund agency - love and respect.
                            </section>
                            <section className="text-xs text-third leading-5 text-justify mb-5">
